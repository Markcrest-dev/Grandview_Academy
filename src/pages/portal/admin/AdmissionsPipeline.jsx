              ...
              <div className="details-panel__body">
                ...
                <div className="panel-avatar-block">
                  <div className="large-avatar">
                    {(() => {
                      const seed = encodeURIComponent(selectedApp.parent_email || selectedApp.first_name || 'applicant');
                      return <img src={`https://api.dicebear.com/9.x/avataaars/svg?seed=${seed}&skinColor=brown,darkBrown,black`} alt={selectedApp.first_name} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} />;
                    })()}
                  </div>
